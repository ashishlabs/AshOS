...
receive a `PluginHost` (`{ kernel, tools, agents, providers, innovation }`)
and register whatever they contribute — tools, agents, provider factories,
or Innovation Intelligence collectors.
