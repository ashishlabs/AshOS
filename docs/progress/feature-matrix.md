...
| Feature | Status | Completion | Quality | Notes |
|---|---|---|---|---|
| Universal Inbox (capture + classify) | 🟡 | 55% | Medium | Real capture/classify/store/archive; classification is regex, not AI; no summarization; no voice/image/document support |
