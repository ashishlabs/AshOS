...
| `api/server.ts` | **472** | ⚠ Needs refactor — grew from 371 lines with the addition of Inbox/Search/Reflect routes. All 50 REST routes in one file. Natural split: `routes/inbox.ts`, `routes/search.ts`, etc. |
