...
- Dashboard (Vite + React + Tailwind v4 + shadcn/ui-style components) with status, providers, agents, tools, plan, workflow, memory, logs, chat, Evolution, and Innovation tabs, a responsive sidebar nav (drawer on mobile), and light/dark theming.
